...
Data_generator.py: Optimal module. Generate the metadata and compare it with raw data. This module is not used by default. More details about the Metadata can be found in DL-PDE (https://arxiv.org/ftp/arxiv/papers/1908/1908.04463.pdf).
